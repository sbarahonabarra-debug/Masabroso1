...
# Default: fabricar concentrado activado
...
with tabs[3]:
    ...
    fabricar_conc = st.session_state.get("pro_fabricar_conc", True)
    st.caption(
        f"Fabricar Concentrado in-house: {'Sí' if fabricar_conc else 'No'} · (se configura en la barra lateral)"
    )
